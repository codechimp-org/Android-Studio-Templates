...
public class ${activityClass} extends ${preferenceSuperClass} {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        this.getFragmentManager().beginTransaction().replace(android.R.id.content, new AllPreferenceFragment()).commit();
    }
...
<#if parentActivityClass?has_content>
    ...
    protected boolean isValidFragment(String fragmentName) {
        return PreferenceFragment.class.getName().equals(fragmentName)
                || AllPreferenceFragment.class.getName().equals(fragmentName);
    }
