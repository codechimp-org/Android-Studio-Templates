<resources>
    ...
    <!-- Example settings for General category -->
    ...
    <!-- Example settings for Data & Sync category -->
    <string name="pref_category_data_sync">Data &amp; sync</string>
    ...
    <!-- Example settings for Notifications category -->
